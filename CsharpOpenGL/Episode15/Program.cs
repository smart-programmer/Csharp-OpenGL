...
using Episode15.toolbox;
using Episode15.entities;
using Episode15.terrains;
...
namespace Episode15
{
    ...
    class Episode15
    {
        ...
        static void Main(string[] args)
        {
            ...
            staticModel.modelTexture.reflectivity = 0f;
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                allTrees.Add(new Entity(staticModel, new Vertex3f((float)x, (float)y, (float)z), 0, 0, 0, rand.Next(1, 4)));
            }
            for (int i = 0; i < 1000; i++)
            {
                double x = random.NextDouble() * -1600 + 800;
            ...
            while (!Glfw.WindowShouldClose(window))
            {
                ...
                foreach (Entity tree in allTrees)
                {
